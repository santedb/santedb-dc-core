...
using SanteDB.DisconnectedClient.Core.Data.Persistence;
...
namespace SanteDB.DisconnectedClient.Core.Data
{
    ...
    public class LocalPersistenceService
    {
        ...
        public static ModelMapper Mapper
        {
            get
            {
                if (m_mapper == null)
                {
                    ...
                    try
                    {
                        m_mapper = new ModelMapper(typeof(LocalPersistenceService).GetTypeInfo().Assembly.GetManifestResourceStream("SanteDB.DisconnectedClient.Core.Data.Map.ModelMap.xml"));
                    }
        ...
        public LocalPersistenceService()
        {
            ...
            foreach (var t in typeof(LocalPersistenceService).GetTypeInfo().Assembly.ExportedTypes.Where(o => o.Namespace == "SanteDB.DisconnectedClient.Core.Data.Persistence" && !o.GetTypeInfo().IsAbstract && !o.GetTypeInfo().IsGenericTypeDefinition))
            {
                try
                {
            ...
            try
            {
                ...
                var map = ModelMap.Load(typeof(LocalPersistenceService).GetTypeInfo().Assembly.GetManifestResourceStream("SanteDB.DisconnectedClient.Core.Data.Map.ModelMap.xml"));
