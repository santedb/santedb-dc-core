...
namespace SanteDB.DisconnectedClient.SQLite.Connection
{
    ...
    public class WriteableSQLiteConnection : LockableSQLiteConnection
    {
        ...
        public WriteableSQLiteConnection(ISQLitePlatform sqlitePlatform, ConnectionString connectionString, SQLiteOpenFlags openFlags, bool storeDateTimeAsTicks = true, IBlobSerializer serializer = null, IDictionary<String, TableMapping> tableMappings = null, IDictionary<Type, String> extraTypeMappings = null, IContractResolver resolver = null) :
