...
namespace SanteDB.DisconnectedClient.Core.Security
{
        ...
        public void ChangePassword(string userName, string password, System.Security.Principal.IPrincipal principal)
        {
            ...
            try
            {
                ...
                if (userName != principal.Identity.Name &&
                    pdp.GetPolicyOutcome(principal, PolicyIdentifiers.ChangePassword) == SanteDB.Core.Model.Security.PolicyGrantType.Deny)
    ...
    /// SQLite principal.
    /// </summary>
    public class SQLitePrincipal : ClaimsPrincipal, IPrincipal
    {
