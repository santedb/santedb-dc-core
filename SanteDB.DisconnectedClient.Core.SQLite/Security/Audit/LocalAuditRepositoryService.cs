...
namespace SanteDB.DisconnectedClient.Core.Security.Audit
{
    ...
    public class LocalAuditRepositoryService : IAuditRepositoryService
    {
        ...
        // Model mapper
        private ModelMapper m_mapper = new ModelMapper(typeof(LocalAuditRepositoryService).GetTypeInfo().Assembly.GetManifestResourceStream("SanteDB.DisconnectedClient.Core.Security.Audit.Model.ModelMap.xml"));
