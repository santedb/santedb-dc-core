...
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'22A9D01F24A7544A9A57010D48DC8A4C', '1.3.6.1.4.1.33349.3.1.5.9.2', 'Unrestricted All', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'A1E93CAB16059C4495A03E188D35EDEF', '1.3.6.1.4.1.33349.3.1.5.9.2.0.5', 'Create Device', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'50C79BE17913534DAB18ED67D269AFAD', '1.3.6.1.4.1.33349.3.1.5.9.2.0.6', 'Create Application', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'5110E75EE5B00A4BA9FE402EDC769731', '1.3.6.1.4.1.33349.3.1.5.9.2.0.7', 'Administer Concept Dictionary', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'A2B29AC5B69AEF4A8C1F60C4C0158DBB', '1.3.6.1.4.1.33349.3.1.5.9.2.0.8', 'Alter Identity', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'9AB16EF2D5E3884BA717A05CB67BEA34', '1.3.6.1.4.1.33349.3.1.5.9.2.0.9', 'Alter Policy', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'00DB8B3A72DDAD469535070794CC70B4', '1.3.6.1.4.1.33349.3.1.5.9.2.0.10', 'Administer Data Warehouse', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'7773370DB72F8D49BB0F6FA3D46A5B8C', '1.3.6.1.4.1.33349.3.1.5.9.2.1.0', 'Login as a Service', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'1401E1D4E814DF4E9B165D74564319F9', '1.3.6.1.4.1.33349.3.1.5.9.2.2.4', 'Export Clinical Data', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'ACB10C29583CBD48A2D261A7685C4E65', '1.3.6.1.4.1.33349.3.1.5.9.2.4.1.0', 'Write Materials', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'B7FD4EF611098042819D3F1E4A382E2E', '1.3.6.1.4.1.33349.3.1.5.9.2.4.1.1', 'Delete Materials', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'B53E8ECA9A881E49BEADE5C8F496015A', '1.3.6.1.4.1.33349.3.1.5.9.2.4.0.1.2', 'Read Materials', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'52BDFED68316FD4EBAC6BC7FAAB20EA5', '1.3.6.1.4.1.33349.3.1.5.9.2.4.0.1.3', 'Query Materials', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'2672A205BDE71441922966EC9DC5C359', '1.3.6.1.4.1.33349.3.1.5.9.2.4.2.0', 'Write Places & Orgs', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'66CF9F4539096C4EBAA335894280D28E', '1.3.6.1.4.1.33349.3.1.5.9.2.4.2.1', 'Delete Places & Orgs', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'21406C9063414F44854B4CD47C41A964', '1.3.6.1.4.1.33349.3.1.5.9.2.4.0.2.2', 'Read Places & Orgs', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'A04B230565F93B418F55A6A94DDBC0BF', '1.3.6.1.4.1.33349.3.1.5.9.2.4.0.2.3', 'Query Places & Orgs', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'AFC54F59A8E70445A8A33EEFC91310B5', '1.3.6.1.4.1.33349.3.1.5.9.2.4', 'Unrestricted Metadata', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'8895C70909B8AC4B95CF00559C75A2B4', '1.3.6.1.4.1.33349.3.1.5.9.2.4.0', 'Read Metadata', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'AF6491C9FCDEF240ADF7A99BDCCD14DB', '1.3.6.1.4.1.33349.3.1.5.9.2.5', 'Unrestricted Data Warehouse', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'EBD9E310038B084DA440E15CD75A5DFF', '1.3.6.1.4.1.33349.3.1.5.9.2.5.0', 'Write Warehouse Data', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'134281BC27403E43BD051C4D11ADFF72', '1.3.6.1.4.1.33349.3.1.5.9.2.5.1', 'Delete Warehouse Data', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'D4ABF9FECBAB004C99FF3B8CEF163574', '1.3.6.1.4.1.33349.3.1.5.9.2.5.2', 'Read Warehouse Data', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'EEAFC09240A56D49B6DB6479FA455F32', '1.3.6.1.4.1.33349.3.1.5.9.2.5.3', 'Query Warehouse Data', 0,0);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'D0C2EF11B5DEBF449122F61A9B83A6F4', '1.3.6.1.4.1.33349.3.1.5.9.3', 'Restricted Information', 0,1);
INSERT INTO security_policy (uuid, oid, name, is_public, can_override) VALUES (X'A7FA0686B2B20F44B0F70A4D650E589B', '1.3.6.1.4.1.33349.3.1.5.9.2.999', 'Override Disclosure', 0,0);
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'AA91A8DE4D22594881B3C1EF2320067E', X'A7FA0686B2B20F44B0F70A4D650E589B', X'1DBAD2F6B55BE341B7FB2EC32418B2E1', 0);  --DENY Override disclosure
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'FF91A8DE4D22594881B3C1EF2320067E', X'AFC54F59A8E70445A8A33EEFC91310B5', X'1DBAD2F6B55BE341B7FB2EC32418B2E1', 2);  --GRANT Local Administrator

-- CREATE LOCAL ADMINS
INSERT INTO security_role (uuid, name, description) VALUES (X'8DF6D7E8B55BE341B7FB2EC32418B2E1', 'LOCAL_ADMINISTRATORS', 'Group for users who have local administrative access');
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'FA91F8134234324881B3C1EF2320067E', X'AFC54F59A8E70445A8A33EEFC91310B5', X'8DF6D7E8B55BE341B7FB2EC32418B2E1', 2);  --GRANT Local Administrator READ METADATA
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'5AC1254A5931C848BBCB741911D91CD2', X'22A9D01F24A7544A9A57010D48DC8A4C', X'D221AEC323FC3341BA42B0E0A3B817D7', 2); -- GRANT Access Administrative Function
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'AA91A8DE4D22594881B3C1EBF3B4B2B1', X'A7FA0686B2B20F44B0F70A4D650E589B', X'D221AEC323FC3341BA42B0E0A3B817D7', 0); -- DENY Override disclosure
...
INSERT INTO security_user_role (uuid, role_id, user_id) VALUES (X'58D8DBDAC513A344AD7D1C44CECAAFB3', X'58D8DBDAC513A344AD7D1C44CECAA4B6', X'F05968C93C0480448DABF69D6E86696C');
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'AA91A8DE4D22594881B3C1EB2B4B3D2E', X'A7FA0686B2B20F44B0F70A4D650E589B', X'58D8DBDAC513A344AD7D1C44CECAA4B6', 0);  --DENY Override disclosure
...
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'FBC073EA5931C848BBCB7419115B43BC', X'8895C70909B8AC4B95CF00559C75A2B4', X'FE453FDE43DDA344AD7D1C44CECAA4B6', 2);  -- GRANT LOCAL_USERS Read Metadata
INSERT INTO security_role_policy (uuid, policy_id, role_id, grant_type) VALUES (X'FC965BD16C64004C9F94EA09EEE67D7C', X'AB965BD16C64004C9A58EA09EEE67D7C', X'FE453FDE43DDA344AD7D1C44CECAA4B6', 2); -- GRANT Login
