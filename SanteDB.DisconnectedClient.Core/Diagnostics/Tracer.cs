...
namespace SanteDB.DisconnectedClient.Core.Diagnostics
{
	/// <summary>
	/// Represents a logger
	/// </summary>
	public sealed class Tracer 
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SanteDB.DisconnectedClient.Core.Diagnostics.Logger"/> class.
		/// </summary>
		...
		/// Creates a logging interface for the specified source
		/// </summary>
		public static Tracer GetTracer (Type sourceType, SanteDBConfiguration configuration)
		{
