	...
	public class LocalBatchService : IBatchRepositoryService, IAuditEventSource, IRepositoryService<Bundle>
	{
        ...
        public Bundle Insert(Bundle data)
		{
            ...
            ApplicationContext.Current.GetService<IThreadPoolService>().QueueUserWorkItem(o =>
                ApplicationContext.Current.GetService<IQueueManagerService>().Outbound.Enqueue(Bundle.CreateBundle(data.Item, data.TotalResults, data.Offset), SynchronizationOperationType.Insert)
            );
        ...
        public Bundle Obsolete(Bundle obsolete)
		{
            ...
            ApplicationContext.Current.GetService<IQueueManagerService>().Outbound.Enqueue(obsolete, SynchronizationOperationType.Obsolete);
