...
namespace SanteDB.DisconnectedClient.Core.Services
{
	...
	public abstract class DataQueryEventArgs<TData> : DataQueryEventArgsBase<TData> where TData : class
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SanteDB.DisconnectedClient.Core.Services.DataQueryPreEventArgs"/> class.
		/// </summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SanteDB.DisconnectedClient.Core.Services.DataQueryResultEventArgs"/> class.
		/// </summary>
		/// <param name="query">Query.</param>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="SanteDB.DisconnectedClient.Core.Services.DataPersistencePreEventArgs"/> class.
		/// </summary>
	...
	public class DataPersistenceEventArgs<TData> : EventArgs where TData : class
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SanteDB.DisconnectedClient.Core.Services.DataPersistenceEventArgs"/> class.
		/// </summary>
		/// <param name="data">Data.</param>
