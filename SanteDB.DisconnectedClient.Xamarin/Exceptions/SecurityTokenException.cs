...
namespace SanteDB.DisconnectedClient.Xamarin.Exceptions
{
    ...
    public class SecurityTokenException : SecurityException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SanteDB.DisconnectedClient.Xamarin.Exceptions.TokenSecurityException"/> class.
        /// </summary>
